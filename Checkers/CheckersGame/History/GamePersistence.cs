...
public static class GamePersistence
{
    ...
    private static string SerializeGame(Game game)
    {
        ...
        var gameState = new GameSaveState{
            ...
            InitialBoardState = SerializeInitialBoard(game.GetHistory()),
            Moves = SerializeMoves(game.GetHistory().GetAllMoves())
        };
        
        return JsonSerializer.Serialize(gameState);
    }

    private static List<PieceSaveState> SerializeInitialBoard(Board board)
    {
    ...
    private static Game DeserializeGame(string json)
    {
        ...
        var game = new Game(gameState.Player1Name, gameState.Player2Name);
    ...
    private class MoveSaveState
    {
        ...
        public int CaptureColumn { get; set; }
        public PieceColor CaptureColer { get; set; }
